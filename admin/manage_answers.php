              ...
              <?php foreach($rows as $r): ?>
                <tr>
                  ...
                  <td class="table-actions">
                    <a href="<?php echo BASE_URL; ?>answers/edit.php?id=<?php echo (int)$r['id']; ?>" class="tag-chip tag-chip-small">Edit</a>
                    <a href="<?php echo BASE_URL; ?>answers/delete.php?id=<?php echo (int)$r['id']; ?>" class="tag-chip tag-chip-small tag-chip-delete" onclick="return confirm('Delete this answer?')">Delete</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
